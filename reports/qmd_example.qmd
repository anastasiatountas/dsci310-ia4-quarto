...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-1 width=60%}

Horse populations for all provinces in Canada from 1906 - 1972. @fig-1
...
![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-2 width=60%}
